...
INSERT INTO rrr_type (code, rrr_group_type_code, display_value, is_primary, share_check, party_required, description, status, rrr_panel_code) VALUES ('ownership', 'rights', 'Ownership::::Право собственности::::ملكية::::Propriété::::Propietario::::Pronësi::::Proprietário::::ម្ចាស់កម្មសិទ្ធិ::::所有权', true, true, true, '...::::::::...::::...::::...::::...::::...::::...::::...', 'c', 'ownership');
...
INSERT INTO rrr_type (code, rrr_group_type_code, display_value, is_primary, share_check, party_required, description, status, rrr_panel_code) VALUES ('occupation', 'rights', 'Occupation::::Оккупация::::إشغال::::Occupation::::Ocupación::::Pushtim::::Ocupação::::ការកាន់កាប់::::占有', false, true, true, '...::::::::...::::...::::...::::...::::...::::...::::...', 'c', 'simpleRightholder');
...
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('proclamation', 'Proclamation::::Прокламация::::إعلان::::Proclamation::::Proclamacion::::::::Anúncio::::សេចក្តីប្រកាស::::公告', 'c', 'Extension to LADM::::Расширение LADM::::ميزة إضافية للنظام::::Extension au LADM::::Extension a LADM::::::::Extensão para LADM::::ពង្រីកទៅដល់ LADM​::::扩展为 LADM', false);
...
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('utilityBill', 'Utility bill::::::::فاتورة إستخدام::::::::Factura de Servicios Públicos::::::::Taxa de infraestrutura::::វិក័យបត្រទឹកភ្លើង::::物业账单', 'c', 'Utility bill::::::::فاتورة إشتراك::::::::Factura de Servicios Públicos::::::::Taxa de infraestrutura::::វិក័យបត្រទឹកភ្លើង​::::物业账单', false);
